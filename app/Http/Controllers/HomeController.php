...
class HomeController extends Controller {
    ...
    /**
     * Display admin dashboard with statistics, items, categories, and banners.
     */
    public function index() {
        ...
        // جلب البانرات للعرض في لوحة التحكم
    ...
    public function changeProfileUpdate(Request $request) {
        ...
        try {
            ...
            ResponseService::logErrorResponse($th, "HomeController --> changeProfileUpdate");
            ResponseService::errorResponse();
        }
    }
