...
Route::post('/upload-csv', [ApiController::class, 'upload']);
Route::post('/forget-password', [ApiController::class, 'forgetPassword']); // طلب إعادة تعيين (إيميل أو رقم)
Route::post('/reset-password', [ApiController::class, 'resetPassword']);   // تعيين كلمة مرور جديدة بعد تحقق OTP
Route::get('/test-bulk-upload', [ApiController::class, 'testBulkUpload']);
Route::post('/get-otp',[ApiController::class,'getOtp']);
...
//Route::get('/items/{id}', [ApiController::class, 'getItemDetailsLight']);
Route::get('/banners', [ApiController::class, 'getBanners']);
Route::get('items-with-banners', [ApiController::class, 'getItemsWithBanners']);
