    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                {{-- Banner Management (جديد) --}}
                {{-- @canany(['banner-list','banner-create','banner-update','banner-delete']) --}}
                    {{-- <div class="sidebar-new-title">{{ __('Banner Management') }}</div> --}}
                    {{-- <li class="sidebar-item"> --}}
...
@can('csv-upload')
<li class="sidebar-item">
    <a href="{{ route('admin.csv.upload') }}" class='sidebar-link'>
        <i class="bi bi-upload"></i>
        <span class="menu-item">{{ __('CSV Upload') }}</span>
    </a>
</li>
@endcan
