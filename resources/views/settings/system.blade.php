...
@section('content')
    <section class="section">
        <form class="create-form-without-reset" action="{{route('settings.store') }}" method="post" enctype="multipart/form-data" data-success-function="successFunction">
            <!-- حذفنا data-parsley-validate من هنا -->
            @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-6 col-xs-12">
                                    ...
                                    <div class="mt-2 d-flex align-items-center">
                                        <div class="form-check me-3">
                                            <input type="radio" id="currency_symbol_left" name="currency_symbol_position" value="left" class="form-check-input" {{ $settings['currency_symbol_position'] === 'left' ? 'checked' : '' }}>
                                            <label for="currency_symbol_left" class="form-check-label">{{ __('Left') }}</label>
                                        </div>
                                        <div class="form-check">
                                            <input type="radio" id="currency_symbol_right" name="currency_symbol_position" value="right" class="form-check-input" {{ $settings['currency_symbol_position'] === 'right' ? 'checked' : '' }}>
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input id="android_version" name="android_version" type="text" class="form-control" placeholder="{{ __('Android Version') }}" value="{{ $settings['android_version']?? '' }}">
                                </div>
                                <div class="form-group col-sm-12 col-md-6">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <input id="ios_version" name="ios_version" type="text" class="form-control" placeholder="{{ __('IOS Version') }}" value="{{ $settings['ios_version'] ?? '' }}">
                                </div>
                                <div class="form-group col-sm-12 col-md-6">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input checkbox-toggle-switch" type="checkbox" role="switch" id="switch_Free_ad_listing" {{ $settings['free_ad_listing'] == '1' ? 'checked' : '' }}>
                                    </div>
                                </div>
                                <div class="form-group col-sm-12 col-md-6 col-xs-12">
                                    <label for="min_length" class="form-label">{{ __('Min Range') }}</label>
                                ...
                                <div class="form-group col-sm-12 col-md-6 col-xs-12">
                                    <label for="max_length" class="form-label">{{ __('Max Range') }}</label>
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    <label class="form-check-label">{{ __('Auto Approve Advertisements') }}</label>
                                    <div class="form-check form-switch">
                                        <input type="hidden" name="auto_approve_item" id="auto_approve_item" value="{{ $settings['auto_approve_item'] ?? 0 }}">
                                        <input class="form-check-input checkbox-toggle-switch" type="checkbox" role="switch" id="switch_auto_approve_item" {{ $settings['auto_approve_item'] == '1' ? 'checked' : '' }}>
                                    </div>
                                </div>
                                <div class="form-group col-sm-12 col-md-6">
                                    <label class="form-check-label">{{ __('Auto Approve Edited Advertisements') }}</label>
                                    <div class="form-check form-switch">
                                        <input type="hidden" name="auto_approve_edited_item" id="auto_approve_edited_item" value="{{ $settings['auto_approve_edited_item'] ?? 0 }}">
                                        <input class="form-check-input checkbox-toggle-switch" type="checkbox" role="switch" id="switch_auto_approve_edited_item" {{ $settings['auto_approve_edited_item'] == '1' ? 'checked' : '' }}>
                                    </div>
                                </div>
                                <div class="form-group col-sm-12 col-md-6">
                                    <label for="map_provider" class="form-label mt-2">{{ __('Map Provider') }}</label>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mt-3">
                        <div class="col-md-12">
                            ...
                            <input id="scheme" name="deep_link_scheme" type="text" class="form-control" placeholder="e.g., myapp" pattern="^[a-z][a-z0-9]*$" title="Must start with a letter, lowercase, and contain no spaces or special characters." value="{{ $settings['deep_link_scheme'] ?? '' }}">
                            <small class="text-muted d-block mt-1">Must start with a letter, be lowercase, and contain no spaces or special characters.</small>
                            <small class="text-muted">Example: <strong>myapp://</strong></small>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <div class="form-check form-switch">
                                ...
                                <input class="form-check-input auth" type="checkbox" id="apple_authentication" name="apple_authentication" value="1" {{ isset($settings['apple_authentication']) && $settings['apple_authentication'] == 1 ? 'checked' : '' }}>
                                <label class="form-check-label">{{ __('On / Off') }}</label>
                            </div>
                        </div>
                    </div>
